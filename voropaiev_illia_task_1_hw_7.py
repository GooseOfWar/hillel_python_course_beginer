...
def square_parameters(data):
    """Function check data is.digit and calculate square parameters"""
    while not data.isdigit():  # If data not only digits ask again
        data = input("Incorrect Data. Use only digit.\n")
    # if data is only digit: calculate perimetr diagonal and area of square
    ...
    print((f'Square Perimeter {perimeter} mm',
           f'Square diagonal {diagonal} mm',
           f'Square area {area} mm^2'))
