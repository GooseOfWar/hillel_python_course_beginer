...
возвращает строку - время года, этого месяца
"""

user_data: str = input('Fill-up number of month\n')  # user input data


def season_by_month(number_of_month):
    """Function just print data from the dict"""
    ...
    # if all is OK convert type on int
    month_number = int(number_of_month)
    list_of_month: list = ['January', 'February', 'March', 'April', 'May', 'June',
    ...
    dict_of_month: dict = {'January': 'Winter', 'February': 'Winter',
                           ...
                           'August': 'Summer', 'September': 'Autumn',
                           'October': 'Autumn', 'November': 'Autumn',
                           'December': 'Winter'}  # dict with equal season
    # print formatting str
    print(
        f'{list_of_month[month_number - 1]} it\'s '
        f'a {dict_of_month[list_of_month[month_number - 1]]} !'
    )
